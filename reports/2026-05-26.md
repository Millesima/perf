...
**CrUX (URL)** : LCP 1393 ms, INP n/a ms, CLS 0.018 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1285 ms, INP n/a ms, CLS 0.018 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1538 ms, INP n/a ms, CLS 0.017 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1795 ms, INP n/a ms, CLS 0.006 (overall : FAST)
**Top opportunités** :
...
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 1750 ms
- Reduce unused CSS — gain estimé ~ 450 ms
...
**CrUX (URL)** : LCP 1344 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
