...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1401 ms, INP n/a ms, CLS 0.028 (overall : SLOW)
**Top opportunités** :
...
**Scores** : Performance 70, Accessibilité 93, Best Practices 69, SEO 92
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1890 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
- Reduce unused CSS — gain estimé ~ 150 ms
...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1388 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
