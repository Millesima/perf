...
**CrUX (URL)** : LCP 1600 ms, INP n/a ms, CLS 0.008 (overall : AVERAGE)
**Top opportunités** :
...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1709 ms, INP n/a ms, CLS 0.026 (overall : SLOW)
**Top opportunités** :
...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 2082 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1730 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
