...
**Δ vs J-1** : Perf -23, Acc +0, BP +18, SEO +0
**CrUX (URL)** : LCP 1655 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**Top opportunités** :
- Initial server response time was short — gain estimé ~ 400 ms
...
**Δ vs J-1** : Perf -8, Acc +0, BP +3, SEO +0
**CrUX (URL)** : LCP 2319 ms, INP n/a ms, CLS 0.007 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 640 ms
...
**CrUX (URL)** : LCP 1297 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
