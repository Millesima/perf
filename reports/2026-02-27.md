...
**CrUX (URL)** : LCP 1703 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 750 ms
- Reduce initial server response time — gain estimé ~ 568 ms
...
**CrUX (URL)** : LCP 2388 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1503 ms, INP n/a ms, CLS 0.011 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1785 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
...
**Δ vs J-1** : Perf -10, Acc +0, BP +0, SEO +0
**CrUX (URL)** : LCP 1298 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
