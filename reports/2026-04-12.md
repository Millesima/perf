...
**CrUX (URL)** : LCP 1508 ms, INP n/a ms, CLS 0.007 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1377 ms, INP n/a ms, CLS 0.049 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 2024 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**Δ vs J-1** : Perf +3, Acc +0, BP +0, SEO +0
**CrUX (URL)** : LCP 1522 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1319 ms, INP n/a ms, CLS 0.006 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 120 ms
- Initial server response time was short — gain estimé ~ 44 ms
- Reduce unused CSS — gain estimé ~ 40 ms
