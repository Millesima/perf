...
**CrUX (URL)** : LCP 1371 ms, INP n/a ms, CLS 0.018 (overall : AVERAGE)
**Top opportunités** :
- Reduce unused CSS — gain estimé ~ 300 ms
- Reduce unused JavaScript — gain estimé ~ 240 ms
- Initial server response time was short — gain estimé ~ 35 ms
...
**CrUX (URL)** : LCP 1280 ms, INP n/a ms, CLS 0.016 (overall : AVERAGE)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 240 ms
...
**CrUX (URL)** : LCP 1667 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1332 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
