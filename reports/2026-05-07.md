...
**CrUX (URL)** : LCP 1365 ms, INP n/a ms, CLS 0.018 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1284 ms, INP n/a ms, CLS 0.023 (overall : AVERAGE)
**Top opportunités** :
...
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 1100 ms
...
**CrUX (URL)** : LCP 1246 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
- Initial server response time was short — gain estimé ~ 190 ms
