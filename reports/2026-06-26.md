...
**CrUX (URL)** : LCP 1336 ms, INP n/a ms, CLS 0.044 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1865 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1380 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
- Initial server response time was short — gain estimé ~ 110 ms
- Reduce unused CSS — gain estimé ~ 40 ms
...
**CrUX (URL)** : LCP 1380 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
- Initial server response time was short — gain estimé ~ 155 ms
