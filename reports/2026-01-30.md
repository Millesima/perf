...
**CrUX (URL)** : LCP 1389 ms, INP n/a ms, CLS 0.06 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1731 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1264 ms, INP n/a ms, CLS 0.008 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 120 ms
- Reduce unused CSS — gain estimé ~ 40 ms
