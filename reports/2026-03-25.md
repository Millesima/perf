...
**CrUX (URL)** : LCP 2609 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1571 ms, INP n/a ms, CLS 0.012 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1212 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 40 ms
- Initial server response time was short — gain estimé ~ 0 ms
- Avoid multiple page redirects — gain estimé ~ 0 ms
