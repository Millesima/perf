...
**CrUX (URL)** : LCP 1334 ms, INP n/a ms, CLS 0.049 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1834 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1396 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 80 ms
