...
**CrUX (URL)** : LCP 1787 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1258 ms, INP n/a ms, CLS 0.046 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 2761 ms, INP n/a ms, CLS 0.007 (overall : AVERAGE)
**Top opportunités** :
...
**Δ vs J-1** : Perf +2, Acc +0, BP +0, SEO +0
**CrUX (URL)** : LCP 1359 ms, INP n/a ms, CLS 0.014 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1791 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
...
**Δ vs J-1** : Perf -4, Acc +0, BP +0, SEO +0
**CrUX (URL)** : LCP 1226 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
