...
**CrUX (URL)** : LCP 1524 ms, INP n/a ms, CLS 0.006 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1358 ms, INP n/a ms, CLS 0.052 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1717 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 1620 ms
- Avoid multiple page redirects — gain estimé ~ 0 ms
- Minify CSS — gain estimé ~ 0 ms
