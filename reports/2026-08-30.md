...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1684 ms, INP n/a ms, CLS 0.026 (overall : SLOW)
**Top opportunités** :
...
**Scores** : Performance 45, Accessibilité 93, Best Practices 73, SEO 92
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 2077 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1645 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
- Initial server response time was short — gain estimé ~ 209 ms
- Avoid multiple page redirects — gain estimé ~ 0 ms
