...
**CrUX (URL)** : LCP 1319 ms, INP n/a ms, CLS 0.048 (overall : SLOW)
**Top opportunités** :
...
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 1090 ms
- Reduce unused CSS — gain estimé ~ 150 ms
...
**CrUX (URL)** : LCP 1244 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
