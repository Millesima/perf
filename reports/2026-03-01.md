...
**CrUX (URL)** : LCP 1389 ms, INP n/a ms, CLS 0.056 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1503 ms, INP n/a ms, CLS 0.014 (overall : AVERAGE)
**Top opportunités** :
- Initial server response time was short — gain estimé ~ 234 ms
...
**CrUX (URL)** : LCP 1777 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
