...
**CrUX (URL)** : LCP 1555 ms, INP n/a ms, CLS 0.014 (overall : AVERAGE)
**Top opportunités** :
...
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 1651 ms, INP n/a ms, CLS 0.026 (overall : SLOW)
**Top opportunités** :
...
**Scores** : Performance 46, Accessibilité 89, Best Practices 73, SEO 92
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 2050 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
...
**Scores** : Performance 41, Accessibilité 97, Best Practices 69, SEO 100
*(Pas de baseline J-1 détectée pour cette page/stratégie)*
**CrUX (URL)** : LCP 2050 ms, INP n/a ms, CLS 0.003 (overall : AVERAGE)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 2170 ms
- Reduce unused CSS — gain estimé ~ 150 ms
