...
**CrUX (URL)** : LCP 1588 ms, INP n/a ms, CLS 0.008 (overall : AVERAGE)
**Top opportunités** :
...
**Top opportunités** :
- Initial server response time was short — gain estimé ~ 164 ms
...
**CrUX (URL)** : LCP 1435 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**Scores** : Performance 86, Accessibilité 100, Best Practices 96, SEO 100
**Δ vs J-1** : Perf -5, Acc +0, BP +0, SEO +0
**CrUX (URL)** : LCP 1435 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 80 ms
