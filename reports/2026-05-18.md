...
**CrUX (URL)** : LCP 1327 ms, INP n/a ms, CLS 0.018 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1248 ms, INP n/a ms, CLS 0.013 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1671 ms, INP n/a ms, CLS 0.003 (overall : FAST)
**Top opportunités** :
...
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 160 ms
- Reduce unused CSS — gain estimé ~ 140 ms
...
**Scores** : Performance 88, Accessibilité 100, Best Practices 96, SEO 100
**Δ vs J-1** : Perf +30, Acc +0, BP +23, SEO +0
**CrUX (URL)** : LCP 1295 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
