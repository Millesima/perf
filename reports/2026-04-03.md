...
**CrUX (URL)** : LCP 1538 ms, INP n/a ms, CLS 0.005 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1328 ms, INP n/a ms, CLS 0.048 (overall : SLOW)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1238 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 260 ms
