...
**CrUX (URL)** : LCP 1686 ms, INP n/a ms, CLS 0.004 (overall : AVERAGE)
**Top opportunités** :
...
**CrUX (URL)** : LCP 1408 ms, INP n/a ms, CLS 0.056 (overall : SLOW)
**Top opportunités** :
...
**Scores** : Performance 48, Accessibilité 93, Best Practices 65, SEO 92
**Δ vs J-1** : Perf +1, Acc +0, BP +0, SEO +0
**CrUX (URL)** : LCP 2388 ms, INP n/a ms, CLS 0.006 (overall : FAST)
**Top opportunités** :
- Reduce unused JavaScript — gain estimé ~ 980 ms
- Reduce unused CSS — gain estimé ~ 150 ms
- Initial server response time was short — gain estimé ~ 55 ms
- Avoid multiple page redirects — gain estimé ~ 0 ms
...
**CrUX (URL)** : LCP 1305 ms, INP n/a ms, CLS 0.004 (overall : FAST)
**Top opportunités** :
